 ...
 * metadata only.
 *
 * The interface is deliberately small so a local-disk implementation and an
 * object-store one stay interchangeable.
 */
...
export abstract class StorageProvider {
   ...
   * Both implementations sign identically, so verification belongs to the
   * contract rather than to either driver.
   *
